...
const experiences = [
  ...
  },
  {
    ...
    duration: "2023",
    description: "Worked on UI/UX improvements and React.js applications."
  }
];
    ...
    <div className="max-w-3xl mx-auto p-4">
      ...
      <ol className="relative border-s border-gray-200 dark:border-gray-700">
        <li className="mb-10 ms-6">
          ...
          <h3 className="flex items-center mb-1 text-lg font-semibold">Neural Info Solutions Pvt. Ltd. <span className="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-sm dark:bg-blue-900 dark:text-blue-300 ms-3">Latest</span></h3>
          <time className="block mb-2 text-sm font-normal leading-none">August, 2024 - Present</time>
