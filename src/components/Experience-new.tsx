...
const Experience = () => {
  ...
  return (
    <section id="experience" className="py-20 bg-gradient-to-b from-black via-gray-950 to-black relative overflow-hidden">
      {/* Background Effects */}
          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {experiences.map((exp, index) => (
                ...
                >
                  {/* Timeline dot */}
                  <div className="absolute left-4 lg:left-0 top-8 w-4 h-4 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full border-4 border-black group-hover:scale-125 transition-transform duration-300 hidden lg:block shadow-lg shadow-blue-500/50"></div>
                  ...
                  <GlassCard className="p-6 md:p-8 group-hover:border-blue-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/20">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-r from-gray-800 to-gray-700 rounded-xl flex items-center justify-center shadow-lg">
                          <Image
                            src={exp.logo}
                        ...
                        <div>
                          <h3 className="text-xl md:text-2xl font-semibold text-white mb-1 group-hover:text-blue-400 transition-colors">
                            {exp.company}
                          </h3>
                          <p className="text-blue-400 font-medium text-sm md:text-base bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                            {exp.position}
                          </p>
                        </div>
                      </div>
                      <div className="text-xs md:text-sm text-gray-400 bg-gray-800/50 px-3 py-2 rounded-full border border-gray-700/50 whitespace-nowrap">
                        {exp.duration}
                      </div>
                    </div>
                    ...
                    <div className="mt-6 pt-6 border-t border-gray-800">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {['React.js', 'Node.js', 'MongoDB', 'Express.js', 'JavaScript', 'Git', 'RESTful APIs'].map((skill) => (
                          <span key={skill} className="px-3 py-1 text-xs font-medium bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 rounded-full text-blue-400 hover:from-blue-500/30 hover:to-purple-500/30 transition-colors">
                            {skill}
                          </span>
                        ))}
                      </div>
